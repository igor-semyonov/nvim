local cfg = {
	...
	select_signature_key = "<leader>sn", -- cycle to next signature, e.g. '<M-n>' function overloading
	move_cursor_key = "<leader>sm", -- imap, use nvim_set_current_win to move cursor between current win and floating
}
